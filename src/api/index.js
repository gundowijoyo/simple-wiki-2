...
const queryByPageId =
  "https://id.wikipedia.org/w/api.php?origin=*&action=query&prop=extracts|pageimages|info|pageprops|extlinks&pithumbsize=400&inprop=url&redirects=1000&format=json&pageids=";
const parseByPageId =
  "https://id.wikipedia.org/w/api.php?origin=*&action=parse&section=0&prop=sections&sectionformat=wiki&format=json&pageid=";
export { searchArticleUrl, queryByPageId, parseByPageId };
